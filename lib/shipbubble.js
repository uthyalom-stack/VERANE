 ...
 * @returns {Promise<Object>} Address validation response containing address_code
 */
...
/**
 * Resolves an address_code for Shipbubble API payloads.
 * If an object is passed, calls POST /v1/shipping/address/validate to resolve address_code.
 *
 * @param {Object|string|number} addressObj
 * @returns {Promise<string|number|null>} Resolved address_code
 */
 ...
 *
 * Requires sender_address_code and reciever_address_code per Shipbubble v1 API contract.
 * Automatically resolves address_code via validateAddress if object addresses are provided.
 *
 * @param {Object} params
 ...
 * @param {Object} [params.shipFrom] - Sender details object (auto-resolved if code omitted)
 * @param {Object} [params.shipTo] - Recipient details object (auto-resolved if code omitted)
