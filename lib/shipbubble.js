 ...
 *
 * Server-side client for fetching shipping rates and generating waybill labels.
 * Credentials are strictly read from process.env.SHIPBUBBLE_API_KEY and never exposed to the client.
 */
...
/**
 * Fetch courier shipping rates from Shipbubble API using official contract.
 *
 * @param {Object} params - Rate query parameters.
 * @param {Object} params.senderAddress - Origin address details.
 * @param {Object} params.receiverAddress - Customer delivery destination details.
 * @param {Array} [params.parcels] - Package weight and dimensions.
 * @returns {Promise<Object>} Object containing request_token and list of courier quotes.
 */
...
/**
 * Generate waybill and label for a confirmed order using Shipbubble Labels API.
 *
 * @param {Object} params - Request parameters matching official Labels API contract.
 * @param {string} params.requestToken - Token returned during rate calculation.
 * @param {string} params.serviceCode - Selected courier service code.
 * @param {string} params.courierId - Selected courier ID.
 * @returns {Promise<Object>} Waybill details including waybill_number, label_url, and tracking_url.
 */
