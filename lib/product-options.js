/**
 * Determines if a product requires option selection (color, size, custom sizing, or variants).
 * @param {Object} product - The product object to check.
 * @returns {boolean} True if the product requires option selection, false otherwise.
 */
...
/**
 * Computes the stock status label and styling for a product based on inventory and pre-order state.
 * @param {Object} product - The product object with inventory, variants, and pre-order information.
 * @returns {Object} Object with label, status flags (isSoldOut, isPreOrder, etc.), and colorClass for UI styling.
 */
