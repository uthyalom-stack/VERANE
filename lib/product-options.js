/**
 * Determines whether a product requires selectable options.
 * @param {Object} product - The product to evaluate.
 * @return {boolean} `true` if the product has selectable colors, variants, custom sizing, or a configured size type; `false` otherwise.
 */
...
/**
 * Determines the stock status and display styling for a product.
 * @param {Object} product - The product whose availability should be evaluated.
 * @return {Object} An object containing the status label, availability flag, and CSS class.
 */
