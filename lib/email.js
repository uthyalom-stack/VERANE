...
/*
|--------------------------------------------------------------------------
| VÉRANE Email Dispatcher (Native Resend SDK)
|--------------------------------------------------------------------------
*/
 ...
 * @param {string} [params.name] - The customer's name (defaults to "Valued Customer" if not provided)
 * @returns {Promise<Object>} Result object with success boolean, optional id, and optional error message
 */
...
/**
 * Sends an order receipt confirmation email with attached PDF receipt.
 * @param {Object} params - The email parameters
 * @param {Object} params.order - The order object containing order details, customer info, and totals
 * @param {Buffer} [params.pdfBuffer] - Optional PDF receipt buffer to attach to the email
 * @returns {Promise<Object>} Result object with success boolean, optional id, and optional error message
 */
