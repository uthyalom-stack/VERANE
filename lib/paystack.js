...
/**
 * Finalizes a Paystack order by verifying payment, updating order status, and sending receipt email.
 * This function is idempotent and safe to call multiple times for the same reference.
 * @param {Object} params - The finalization parameters
 * @param {string} params.reference - The Paystack payment reference
 * @param {Object} params.txData - The Paystack transaction data containing status, amount, and payment details
 * @returns {Promise<Object>} Result object with success boolean, alreadyPaid flag, and finalized order object
 * @throws {Error} If reference is missing, order not found, payment verification fails, or amount mismatch occurs
 */
