...
/**
 * Retrieves the customer authentication secret from the environment.
 * @returns {string} The configured customer authentication secret.
 * @throws {Error} If the customer authentication secret is missing.
 */
function getSecret() {
...
/**
 * Verifies a customer's password against a stored salted hash.
 * @param {string} password - The submitted password.
 * @param {string} storedPassword - The stored `salt:hash` value.
...
/**
 * Creates an HMAC-SHA256 signature for a session payload.
 ...
 * Includes a 3-day server-verified expiration claim (`exp`).
...
/**
 * Provides the cookie name used for customer sessions.
 * @return {string} The customer session cookie name.
 */
