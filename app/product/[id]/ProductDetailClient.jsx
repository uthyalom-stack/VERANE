...
export default function ProductDetailClient({ product }) {
  ...
  /*
   * Check wishlist status lazily without blocking initial server HTML render.
   */
  useEffect(() => {
    async function loadWishlistStatus() {
      ...
      try {
        ...
        const isSaved = Array.isArray(data.wishlist)
          ? data.wishlist.some((item) => item.productId === product.id)
          : false;
  ...
  const initialInventory = Math.max(
    0,
    Number(product?.initialInventory ?? inventory)
  );
  ...
  const isPreOrder = Boolean(
    product?.preOrderEnabled || product?.isPreOrder
  );

  const customSizingEnabled = Boolean(product?.customSizingEnabled);

  const fulfillmentTime =
    product?.fulfillmentTime || product?.preOrderFulfillmentTime || "";
  ...
  const hasSizes = variants.some((v) =>
    Boolean(v.size || v.name || v.value || v.label)
  );

  const needsSizeSelection = hasSizes && !isPreOrder;

  const isOutOfStock =
    inventory <= 0 && variants.every((v) => (v.stock ?? v.inventory ?? 0) <= 0);
  ...
  const addOrUpdateSelectedVariant = (colorId, sizeLabel) => {
    ...
    const chosenColorName =
      chosenColorObj?.name ||
      chosenColorObj?.label ||
      chosenColorObj?.value ||
      null;

    const exactVar =
      variants.find((variant) => {
        const vSize =
          variant.size || variant.name || variant.value || variant.label || null;
        ...
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-7">
              ...
              <p className={`text-xs mt-2 font-medium ${stockStatusClass}`}>
                {stockStatus}
              </p>
            </div>
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-3">
                  {productColors.map((color) => {
                    ...
                    const colorName =
                      color.name || color.label || color.value || "Color";
              ...
              <div className="mt-8">
                ...
                <div className="flex flex-wrap gap-2">
                  {Array.from(
                    ...
                    const matchingVariant = variants.find((v) => {
                      const vSize =
                        v.size || v.name || v.value || v.label || null;
                ...
                {isFootwear && (
                  <p className="text-[10px] text-neutral-600 mt-3">
                    Select your usual footwear size. See the sizing guide if you are unsure.
                  </p>
                )}
              </div>
            )}
            ...
            {isPreOrder && (
              <div className="mt-8 rounded-2xl border border-amber-500/20 bg-amber-500/[0.04] p-5">
                ...
                <p className="text-neutral-300 text-sm mt-3 leading-relaxed">
                  This piece is available for pre-order and will be prepared specially for you.
                </p>
            ...
            {isPreOrder && customSizingEnabled && (
              <div className="mt-8">
                ...
                <div className="flex items-center justify-between gap-4 mb-3">
                  <div>
                    ...
                    <p className="text-xs text-neutral-500 mt-1">
                      Enter your measurements or sizing details.
                    </p>
                  </div>
                ...
                <p className="text-[10px] text-neutral-600 mt-2">
                  Your sizing details will be attached to your order for fulfillment.
                </p>
              </div>
            )}
            ...
            <div className="mt-10 border-t border-white/5">
              ...
              {product.style && (
                <div className="flex justify-between gap-5 py-4 border-b border-white/5 text-sm">
                  ...
                  <span className="text-neutral-300 text-right">{product.style}</span>
                </div>
              )}
              ...
              {product.occasion && (
                <div className="flex justify-between gap-5 py-4 border-b border-white/5 text-sm">
                  ...
                  <span className="text-neutral-300 text-right">{product.occasion}</span>
                </div>
              )}
              ...
              {product.outfitLayer && (
                <div className="flex justify-between gap-5 py-4 border-b border-white/5 text-sm">
                  ...
                  <span className="text-neutral-300 text-right">{product.outfitLayer}</span>
                </div>
              )}
        ...
        >
          ...
          >
            ...
            <p className="text-[11px] leading-relaxed text-neutral-600 mt-5">
              If you are between sizes or unsure of your size, use your usual footwear size and consider the fit of the style before ordering.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10">
            ...
            <div className="relative px-7 py-14 md:px-14 md:py-16">
              ...
              <p className="text-neutral-400 text-sm max-w-xl mt-5 leading-relaxed">
                Pair this piece with clothing, footwear and accessories from both VÉRANE collections.
              </p>
