...
const placeOrder = async () => {
  try {
    ...
    router.push(
      `/orders?order=${data.order.orderNumber}`
    );
            ...
            <div className="border border-white/10 bg-neutral-950 rounded-[2rem] p-6 md:p-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4 mt-6">
                ...
                <input
                  ...
                  className="rounded-xl border border-white/10 bg-black px-4 py-4 text-sm outline-none placeholder:text-neutral-600 focus:border-amber-400/50"
                />
              ...
              <p className="text-[10px] text-neutral-500 uppercase tracking-[0.25em] font-bold mt-10">
                Delivery Address
              </p>
              ...
              <div className="space-y-4 mt-6">
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-white/10 bg-black px-4 py-4 text-sm outline-none placeholder:text-neutral-600 focus:border-amber-400/50"
                />
              ...
              <div className="mt-8 border border-white/5 rounded-2xl p-5">
                ...
                <p className="text-xs text-neutral-500 mt-2">
                  Secure payment options will be available at the final payment step.
                </p>
              </div>
