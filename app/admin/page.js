    ...
    <main className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-7xl px-5 pb-24 pt-8 sm:px-8 lg:px-10">
        ...
        <div className="mb-8 flex items-end justify-between">
          <div>
            <p className="mb-2 text-[9px] font-bold uppercase tracking-[0.3em] text-amber-400/80">
              Management
            </p>
          ...
          {sections.map((card) => (
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="mb-2 text-[9px] font-bold uppercase tracking-[0.25em] text-amber-400/60">
                  {card.category}
                </p>
                ...
                <div className="mt-6 flex items-center justify-between border-t border-white/[0.06] pt-4">
                  <span className="text-[10px] font-semibold uppercase tracking-[0.2em] text-white/25 transition-colors group-hover:text-white/50">
                    Manage
                  </span>

                  <span className="text-white/25 transition-all duration-300 group-hover:translate-x-1 group-hover:text-amber-400">
                    →
                  </span>
                </div>
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div>
              ...
              <h2 className="mt-2 text-xl font-semibold tracking-tight">
                Your storefront, your control.
              </h2>

              <p className="mt-2 max-w-2xl text-sm leading-6 text-white/35">
                Every part of VÉRANE is being built to give you
                control without needing to edit the website code
